...
CREATE OR REPLACE FUNCTION match_transactions(
  query_embedding vector(2048), -- Векторное представление (эмбеддинг) для поиска. Размерность 2048.
...
-- Примечание: При изменении размерности вектора (например, с 2048 на другую),
