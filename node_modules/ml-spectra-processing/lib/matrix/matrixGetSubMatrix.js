...
exports.matrixGetSubMatrix = matrixGetSubMatrix;
const matrixCheckRanges_1 = require("./matrixCheckRanges");
/**
...
function matrixGetSubMatrix(matrix, options) {
    ...
    (0, matrixCheckRanges_1.matrixCheckRanges)(matrix, { startColumn, startRow, endColumn, endRow });
