...
function xHilbertTransform(array, options = {}) {
    ...
    if ((0, utils_1.isPowerOfTwo)(length)) {
        return hilbertTransformWithFFT(array);
    }
    else if (forceFFT) {
        return resampling(hilbertTransformWithFFT(resampling(array, (0, utils_1.nextPowerOfTwo)(length))), length);
    }
    else {
...
function hilbertTransformWithFFT(array) {
    const length = array.length;
    const fft = new fft_js_1.default(length);
