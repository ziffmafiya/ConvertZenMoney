...
exports.calculateAdaptiveWeights = calculateAdaptiveWeights;
const xAbsolute_1 = require("../x/xAbsolute");
const xMedian_1 = require("../x/xMedian");
const xSubtract_1 = require("../x/xSubtract");
/**
...
function calculateAdaptiveWeights(yData, baseline, weights, options) {
    ...
    const absResiduals = (0, xAbsolute_1.xAbsolute)((0, xSubtract_1.xSubtract)(yData, baseline));
    const medAbsRes = (0, xMedian_1.xMedian)(absResiduals);
