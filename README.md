...
-   **Визуализация**: Наглядное представление доходов и расходов с помощью диаграмм и графиков, включая улучшенное отображение данных на графике "Траты vs. Доходы" с форматированием валюты и началом оси Y с нуля.
